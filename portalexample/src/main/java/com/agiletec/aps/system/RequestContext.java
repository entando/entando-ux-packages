...
public class RequestContext {
	...
	public RequestContext(){
		this._extraParams = new ConcurrentHashMap<>();
	}
	...
	public Object getExtraParam(String name) {
        if (name.equals(SystemConstants.EXTRAPAR_CURRENT_WIDGET) || name.equals(SystemConstants.EXTRAPAR_CURRENT_FRAME)) {
            return ApsThreadLocal.get(name);
        } else {
