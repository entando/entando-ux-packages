...
<s:if test="#lang.default">
    ...
    <wpsf:select name="%{#currentEnumeratorAttributeName}" id="%{#currentEnumeratorAttributeName}" 
                 headerKey="" headerValue="%{getText('label.none')}" listKey="key" listValue="value" 
                 list="#attribute.items" value="%{#attribute.getText()}" cssClass="form-control" />
</s:if>
<s:else>
    <s:if test="#attributeTracer.listElement">
        ...
        <wpsf:select name="%{#currentEnumeratorAttributeName}" id="%{#currentEnumeratorAttributeName}" 
                     ...
                     list="#attribute.items" listKey="key" listValue="value" 
